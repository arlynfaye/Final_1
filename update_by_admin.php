	...
	if ($Account_C == 'teacher') {
		...
		$row_count= mysqli_num_rows($result);
			...
			elseif ($Pass != $C_Pass) {
				...
				$Database="INSERT INTO teacher(name,email,password,address,Date_of_birth,gender,salary,department)VALUES('$Name','$Email','$Pass','$Address','$Dob','$Sex','$Salary','$Department')";
